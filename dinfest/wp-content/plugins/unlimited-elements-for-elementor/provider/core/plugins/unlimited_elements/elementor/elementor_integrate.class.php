...
class UniteCreatorElementorIntegrate{
	...
	public function onSectionStyleControlsAdd($objControls, $args){
		...
		$arrBGItems = array();
		$arrBGItems[$none] = __("[Not Background]", "unlimited_elements");
        ...
        $textInstallMore = __("To install more backgrounds", "unlimited_elements");
        $textClickHere = __("click here","unlimited_elements");
