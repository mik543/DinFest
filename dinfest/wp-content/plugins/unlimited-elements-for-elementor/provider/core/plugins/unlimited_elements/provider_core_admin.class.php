...
class UniteProviderCoreAdminUC_Elementor extends UniteProviderAdminUC{
	...
	protected function addAdminMenuLinks(){
		...
		$this->addSubMenuPage($this->coreAddonsView, __('Widgets', "unlimited_elements"), "adminPages");
		...
		if($enableBackgrounds == true)
			$this->addSubMenuPage(GlobalsUnlimitedElements::VIEW_BACKGROUNDS, __('Background Widgets', "unlimited_elements"), "adminPages");
