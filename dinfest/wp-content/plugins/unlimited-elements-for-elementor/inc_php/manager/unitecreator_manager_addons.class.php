...
class UniteCreatorManagerAddonsWork extends UniteCreatorManager{
	...
	public function getAddonAdminHtml($objAddon){
		...
		if($this->objAddonType->isSVG == true){
			...
			$textPreview = __("Preview ", "unlimited_elements").$this->textSingle;
			$textEdit = __("Edit ", "unlimited_elements").$this->textSingle;
			
			if($isGroup == true){
				$textPreview = __("Preview Template Kit", "unlimited_elements");
				$textEdit = __("Edit Template Kit", "unlimited_elements");
			}
			
			$textDuplicate = __("Duplicate ", "unlimited_elements").$this->textSingle;
	...
	private function getCatList_addAllCategory($arrCats){
		...
		$arrCat = array();
		$arrCat["id"] = "all";
		$arrCat["title"] = __("All","unlimited_elements");
		$arrCat["alias"] = "";
		$arrCat["ordering"] = 0;
		$arrCat["params"] = "";
		$arrCat["type"] = "";
