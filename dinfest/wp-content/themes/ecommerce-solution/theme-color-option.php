<?php
	...
	$ecommerce_solution_custom_css .='.copyright-wrapper{';
		$ecommerce_solution_custom_css .='padding-top: '.esc_attr($ecommerce_solution_footer_text_padding).'px; padding-bottom: '.esc_attr($ecommerce_solution_footer_text_padding).'px;';
	$ecommerce_solution_custom_css .='}';
	...
	$ecommerce_solution_custom_css .='.more-btn a, .postbtn a, #comments input[type="submit"].submit{';
		$ecommerce_solution_custom_css .='padding-top: '.esc_attr($ecommerce_solution_post_button_padding_top).'px; padding-bottom: '.esc_attr($ecommerce_solution_post_button_padding_top).'px;';
	$ecommerce_solution_custom_css .='}';
	...
	$ecommerce_solution_custom_css .='.postbtn a, #comments input[type="submit"].submit{';
		$ecommerce_solution_custom_css .='padding-left: '.esc_attr($ecommerce_solution_post_button_padding_right).'px; padding-right: '.esc_attr($ecommerce_solution_post_button_padding_right).'px;';
	$ecommerce_solution_custom_css .='}';
	...
	$ecommerce_solution_metafields_date = get_theme_mod( 'ecommerce_solution_metafields_date',false);
	$ecommerce_solution_metafields_author = get_theme_mod( 'ecommerce_solution_metafields_author',false);
	$ecommerce_solution_metafields_comment = get_theme_mod( 'ecommerce_solution_metafields_comment',false);
	...
	if($ecommerce_solution_search == true && get_theme_mod( 'ecommerce_solution_search_enable_disable',false) != true){
	...
	if($ecommerce_solution_myaccount == true && get_theme_mod( 'ecommerce_solution_myaccount_enable_disable',false) != true){
	...
	$ecommerce_solution_custom_css .='.box-image img, .content_box img{';
		$ecommerce_solution_custom_css .='border-radius: '.esc_attr($ecommerce_solution_image_border_radius).'%;';
	$ecommerce_solution_custom_css .='}';

	$ecommerce_solution_image_box_shadow = get_theme_mod('ecommerce_solution_image_box_shadow',0);
	$ecommerce_solution_custom_css .='.box-image img, .content_box img{';
		$ecommerce_solution_custom_css .='box-shadow: '.esc_attr($ecommerce_solution_image_box_shadow).'px '.esc_attr($ecommerce_solution_image_box_shadow).'px '.esc_attr($ecommerce_solution_image_box_shadow).'px #eee;';
	$ecommerce_solution_custom_css .='}';
	...
	$ecommerce_solution_sticky_header_padding = get_theme_mod('ecommerce_solution_sticky_header_padding', 0);
		$ecommerce_solution_custom_css .='.fixed-header{';
			$ecommerce_solution_custom_css .='padding: '.esc_attr($ecommerce_solution_sticky_header_padding).'px;';
		$ecommerce_solution_custom_css .='}';
