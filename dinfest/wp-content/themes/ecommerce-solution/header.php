          ...
          <div class="row">
            <div class="col-lg-3 col-md-4 col-9">
              <?php if ( get_theme_mod('ecommerce_solution_phone_number','') != "" ) {?>
                <span><i class="<?php echo esc_attr(get_theme_mod('ecommerce_solution_phone_icon','fas fa-phone')); ?>"></i><?php echo esc_html_e( 'Call Now:', 'ecommerce-solution' ); ?><a class="call1" href="tel:<?php echo esc_attr( get_theme_mod('ecommerce_solution_phone_number','' )); ?>"><?php echo esc_html( get_theme_mod('ecommerce_solution_phone_number','') ); ?><span class="screen-reader-text"><?php echo esc_html( get_theme_mod('ecommerce_solution_phone_number','') ); ?></span></a></span>
              <?php }?>
            </div>
            <div class="col-lg-9 col-md-8 col-3">
              ...
              if(has_nav_menu('topmenus')){ ?>
                <div class="toggle-menu responsive-menu">
                  <button role="tab" class="mobile-toggle" onclick="ecommerce_solution_responsive_menu_open()"><i class="<?php echo esc_attr(get_theme_mod('ecommerce_solution_responsive_menu_open_icon','fas fa-bars')); ?>"></i><span class="screen-reader-text"><?php esc_html_e('Open Menu','ecommerce-solution'); ?></span>
                  </button>
                </div>
              <?php }?>
          ...
          <div class="row">          
            <div class="<?php if( get_theme_mod( 'ecommerce_solution_cart_enable_disable', true) != '') { ?> col-lg-10 col-md-9"<?php } else { ?>col-lg-12 col-md-12 <?php } ?>">
              ...
              if(has_nav_menu('primary')){ ?>
                <div class="toggle-menu responsive-menu">
                  <button role="tab" onclick="ecommerce_solution_menu_open()" class="mobiletoggle"><i class="<?php echo esc_attr(get_theme_mod('ecommerce_solution_responsive_menu_open_icon','fas fa-bars')); ?>"></i><span class="screen-reader-text"><?php esc_html_e('Open Menu','ecommerce-solution'); ?></span>
                  </button>
                </div>
              <?php }?>
            ...
            <?php if( get_theme_mod( 'ecommerce_solution_cart_enable_disable', true) != '' ) {?>
              <div class="<?php if(get_theme_mod( 'ecommerce_solution_sticky_cart',false) != '') { ?> sticky-cart"<?php } else { ?>col-lg-2 col-md-3 close-cart <?php } ?>">
